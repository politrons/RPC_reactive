 ...
 *
 * Now that client and server side share the [StreamObserver<ReactiveRequest>] the communication can run.
 ...
 */
public class ReactiveBenchmarkServiceImpl extends ReactiveServiceGrpc.ReactiveServiceImplBase {
